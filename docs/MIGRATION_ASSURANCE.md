...
**Count:** 24 forward migrations (001–024; includes `024_reset_dock_icon_follow_macos.sql`)
...
| 024 | `024_reset_dock_icon_follow_macos.sql` | Reset stored Dock preference to Follow macOS while manual selection is dormant |
...
Forward migrations are fixture-tested for common upgrade stops (006, 011–015) and fresh installs through `024_reset_dock_icon_follow_macos`. Large-volume and export-after-upgrade assurance remain open.
